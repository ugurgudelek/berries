...
from cnn_visualization.vanilla_backprop import VanillaBackprop
# from cnn_visualization.guided_backprop import GuidedBackprop  # To use with guided backprop
