class Trainerv1:
    def __init__(self,
        ...
        self.train_loader = DataLoader(
            ...
            shuffle=self.hyperparams.get('train_shuffle', True),
            num_workers=0,
    ...
    def fit(self):
        ...
        try:
            ...
            for epoch in range(self.start_epoch,
                ...
                loss_container = list()
                metric_container = defaultdict(list)
                for loss, output, target in self._on_epoch(train=True,
                                                           epoch=epoch):
                    loss_container.append(loss.item())
                    metric_container = self._calculate_metrics(
                        yhat=output, y=target, container=metric_container)
                ...
                if epoch % self.params['log_interval'] == 0:
                    ...
                    self.plotter.learning_curve(
                        read_dir=self.experiment_fpath,
