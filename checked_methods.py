...
def cluster_features(p_stock_names,hierarcy_no_plot=True,stock_with_metric_path="input/stock_with_metrics", save_path="input/"):
...
def create_images_from_data(stock_names, p_sorted_predictor_names, split_period=28, label_names=['label_day_is_less','label_day_is_more'],
    ...
    for stock_name in stock_names:
        ...
        raw_data = pd.read_csv(stock_with_labels_path+"/{}.csv".format(stock_name))
